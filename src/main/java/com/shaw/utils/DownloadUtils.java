...
public class DownloadUtils {
  ...
  public static final String UA =
      "Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.1599.101 Safari/537.36";
  ...
  /** url 下载链接 savePath 保存路径(由url获取名字) */
  ...
  /** url 下载链接 filePath 保存文件路径(名字由filepath定义) */
  ...
  /** 使用文件内存映射保存文件 */
  private static String saveStreamToFile(InputStream is, String savePath, long contentLength)
      throws IOException {
  ...
  /** 设置请求头 Referer必须设置，否则可能无法请求道pixiv的资源 超时时间必须设置，如果一直请求为返回，可能导致线程死锁 */
