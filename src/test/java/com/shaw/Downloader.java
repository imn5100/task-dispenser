...
public class Downloader extends Observable {
    ...
    public Downloader(String url, String savePath) throws IOException {
        //超时一小时
        this(url, savePath, 1000 * 60 * 60, 50);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Header UAHeader = new Header("User-Agent", "Mozilla/5.0 (Windows NT 6.2; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.101 Safari/537.36");
        Header REFHeader = new Header("Referer", "http://spapi.pixiv.net/");
